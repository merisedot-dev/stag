...
class StagApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='com.github.merisedotdev.stag',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS,
                         resource_base_path='/com/github/merisedotdev/stag')
    ...
    def do_activate(self):
        ...
        if not win:
            win = StagWindow(application=self)
        win.present()
